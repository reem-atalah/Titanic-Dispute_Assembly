...
.DATA
    ...
    S_x dw 100,200 ;x position of the ball
    S_y dw 30,50 ;y position of the ball
    V_x dw 3H,19H ;Horizontal Velocity
    V_y dw 3H,12H ;Vertical Velocity
    storeSI dw ?
    storeDI dw ?
    storeBP dw ?
    colorBall db 0eh
